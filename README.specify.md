# Chapter 180: FL Gradient Compression

## Описание

Сжатие градиентов для снижения communication overhead.
...
1. **Gradient Compression for Distributed Deep Learning**
   - URL: https://arxiv.org/abs/1702.01754
   - Год: 2017
